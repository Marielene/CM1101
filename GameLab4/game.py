...
def display_room(room):
    ...
    """
    print('\n' + room['name'].upper() + '\n' + '\n' + room['description'] + '\n')
    #if I use a single \n in the middle it won't print out.
    # pass # The pass statement does nothing. Replace it with the body of your function.
...
def exit_leads_to(exits, direction):
    ...
    #stands for room > provided exit > provided direction > name of exit
    #pass
...
def menu(exits):
    ...
    while True:
        ...
        ui=input(">> ")
        # Normalise the input
        nui=normalise_input(ui)
        # Check if the input makes sense (is valid exit)
        if is_valid_exit(exits, nui):
