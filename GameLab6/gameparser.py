...
def filter_words(words, skip_words):
    ...
    """
    #words="".join(c for c in text if c not in skip_words)
    #fil=[c for c in words if c not in skip_words]
    #fil = [" ".join([a for a in b.split() if not a in skip_words]) for b in words]
    #words=words.lower()
